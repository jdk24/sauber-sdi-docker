...
ALTER TABLE station_data.fv_wfs OWNER TO postgres;
...
GRANT ALL ON FUNCTION station_data.parse_json() TO sauber_user;
...
GRANT SELECT,INSERT ON TABLE station_data.tab_prediction TO sauber_user;
...
GRANT SELECT,INSERT ON TABLE station_data.lut_component TO sauber_user;
...
GRANT SELECT,INSERT,UPDATE ON TABLE station_data.lut_station TO sauber_user;
...
GRANT SELECT,INSERT ON TABLE station_data.logtable TO sauber_user;
...
GRANT SELECT,INSERT,UPDATE ON TABLE station_data.lut_region TO sauber_user;
...
GRANT SELECT,USAGE ON SEQUENCE station_data.lut_region_idpk_region_seq TO sauber_user;
...
GRANT SELECT ON TABLE station_data.raw_input TO anon;
GRANT SELECT,INSERT ON TABLE station_data.raw_input TO sauber_user;
...
GRANT SELECT,USAGE ON SEQUENCE station_data.raw_input_idpk_json_seq TO sauber_user;
...
GRANT SELECT,USAGE ON SEQUENCE station_data.tab_value_idpk_value_seq TO sauber_user;
